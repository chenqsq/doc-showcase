...
它的意思是：平台先把公共机制、教师运营入口和学科接入契约定死，再让新学科在固定槽位里补目录、补桥和专属策略。  
`学科接入模板` 这个对象为什么存在、归谁管，看本文；对象本体长什么样，去下游模板文档看。

| 类别 | 平台固定 | 学科可补 | 暂留槽位 |
| --- | --- | --- | --- |
| 平台公共边界 | 目录树、当前任务卡、双层笔记、阶段复习、教师运营入口 | 不可重写平台主机制 | P1/P2 增强能力 |
| 学科接入契约 | 学科大类、学科定位、目录结构、补桥逻辑、笔记模板 | 可以补学科专属策略与资源模板 | 后续更多学科大类与学科示范 |
| 扩科槽位 | 统一接入模板和字段 | 允许填入新学科资产 | `扩科槽位` 用于后续接入语言、计算机/专业技能、考试/证书 |

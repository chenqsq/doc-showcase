...
| 课程编号 | `course_id` | 当前课程的正式标识 | `高等数学A` | 是 | 锁定课程边界 |
...
| 自定义变量集合 | `custom_variables.*` | 运行时透传的业务上下文 | `course_id=高等数学A` | 运行时必填 | 课程、班级、入口等动态边界 |

### 4.2 `custom_variables.*` 推荐子字段

| 中文字段名 | 英文字段键 | 含义 | 示例 | 是否必填 | 检索用途 |
| --- | --- | --- | --- | --- | --- |
| 课程编号 | `custom_variables.course_id` | 对话实际服务的课程 | `高等数学A` | 是 | 与正式课程边界对齐 |
...
- `高等数学A-M01函数极限连续-CH01函数概念-知识点卡-函数是规则.md`
- `高等数学A-M02导数与微分-CH02导数定义-例题讲解卡-导数定义求极限.md`
- `高等数学A-M05定积分及其应用-CH05面积问题-课堂重构笔记-定积分面积直觉.md`
- `高等数学A-M02导数与微分-CH02导数定义-错题与误区卡-把导数当作斜率结论背诵.md`

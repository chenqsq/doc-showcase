...
本文是 `平台动作面` 和 `子引擎能力面` 的唯一正式定义源。  
前者回答“平台怎么组织学习”，后者回答“AI教师子引擎这一节怎么教、怎么练、怎么评”。  
后续产品总纲、子引擎 PRD、学科示范和答辩文档只负责承接、实例化或做人话翻译，不再重新定义这两个词。

| 面 | 核心问题 | 典型动作项 / 能力项 |
| --- | --- | --- |
| 平台动作面 | 学什么、何时推进、如何沉淀、怎样扩学科 | 学习建档、目录树、当前任务卡、自动推进、阶段复习、教师运营入口、学科接入 |
| 子引擎能力面 | 这一节怎么诊断、讲解、练习、测评和复盘 | 诊断、分层讲解、练习测评、错因归因、复盘计划、教师运营分析 |
...
- 平台架构的关键不只是分层，而是对象流转。
- `平台动作面` 和 `子引擎能力面` 是平台层与子引擎层最重要的分工边界。

...
2. 任务追踪：FR + AC 双层追踪。
3. 项目定位：平台主导，AI教师作为教学执行子引擎。
4. 推进策略：子引擎 `P0` 优先冲刺，再推进 `P1/P2`。
5. 证据格式：每次平台操作回传 `1 张截图 + 3-5 个关键字段`。

const n=`# P2 外部接入与产品后端架构设计（AI教师版）

> 版本：v1.0  
> 文档属性：阶段架构版（P2）  
> 目标：讲清自定义前端、产品后端/BFF 与 ADP 的接入关系  

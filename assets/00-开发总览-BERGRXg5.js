...
如果你是第一次进入项目，先回 [../作品文档/真人类文档/00-PRD需求分析.md](../作品文档/真人类文档/00-PRD需求分析.md)。
...
- 这组文档是工程参考，不再与真人类文档主线争入口。
- 真正讲作品是什么、怎么展示、怎么答辩的地方，已经固定回到 \`doc/作品文档/真人类文档\`。
- 这里保留的价值是：把实现细节讲清，把工程约束讲清，把联调路径讲清。
- 如果你要正式接手工程落地，下一站先读 [10-比赛项目接手基线](./10-比赛项目接手基线.md)。
- 如果你要继续推进腾讯“应用包生成助手”产物，下一站读 [11-ADP应用包生成输入包](./11-ADP应用包生成输入包.md)。
`;export{n as default};
